            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                >
                    <div className="relative z-10 w-full md:w-1/2">
                        ...
                        <h3 className="text-2xl md:text-3xl font-bold mb-4">정기 청소 이벤트</h3>
                    ...
                    <div className="relative z-10 hidden md:block w-1/2 h-full">
                        <img src="/assets/event_cleaning.png" alt="Regular Cleaning" className="object-contain w-full h-full transform scale-125 translate-x-10 translate-y-10" />
                    </div>
                </motion.div>
