        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="bg-[#1a233a] rounded-2xl p-8 md:px-12 relative overflow-hidden flex flex-col md:flex-row justify-between items-center h-72 md:h-80"
                >
                    <div className="relative z-10 w-full md:w-1/2">
                        <span className="inline-block bg-blue-500 text-white px-3 py-1 rounded-full text-sm font-bold mb-4">EVENT 01</span>
                        <h3 className="text-2xl md:text-3xl font-bold mb-4 text-white">정기 청소 이벤트</h3>
                        <p className="text-lg text-gray-200">정기 청소 1년 계약 시 <br className="hidden md:block" /><span className="text-yellow-400 font-bold">대청소 1회 무료 서비스</span></p>
                    </div>
                    <div className="relative z-10 hidden md:block w-1/2 h-full">
                        <img src="/assets/event_cleaning.png" alt="Regular Cleaning" className="object-contain w-full h-full transform scale-125 translate-x-10 translate-y-6" />
                    </div>
                </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    >
                        ...
                        <div className="absolute right-0 bottom-0 w-1/2 h-full">
                            <img src="/assets/event_ac.png" alt="AC Cleaning" className="w-full h-full object-contain transform translate-x-4 translate-y-4" />
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="absolute right-0 bottom-0 w-1/2 h-full">
                            <img src="/assets/event_disinfection.png" alt="Disinfection" className="w-full h-full object-contain transform translate-x-4 translate-y-4" />
                        </div>
                    </motion.div>
                </div>
            </div>
