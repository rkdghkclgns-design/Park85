...
export const allServices: ServiceItem[] = [
    { id: "svc-1", name: "정기 청소", description: "사무실/상업공간 정기 청소", image: "./assets/services/regular_cleaning.png?v=5" },
...
export const regularCleaningServices: ServiceItem[] = [
    { id: "reg-1", name: "바닥청소", description: "전문 장비 활용 바닥 스크러빙", image: "./assets/services/regular_cleaning.png?v=5" },
...
export const disinfectionServices: ServiceItem[] = [
    { id: "dis-1", name: "감염병 예방", description: "법정 의무 소독 및 증명서 발급", image: "./assets/services/service_disinfection.png?v=5" },
    ...
    { id: "dis-4", name: "연무 소독", description: "초미립자 연무 공간 살균", image: "./assets/services/space_disinfection.png?v=5" },
    { id: "dis-5", name: "분무 소독", description: "표면 접촉부 집중 살균", image: "./assets/services/space_disinfection.png?v=5" },
];
